...
mltb_a --allow-overwrite=true --auto-file-renaming=true --bt-enable-lpd=true --bt-detach-seed-only=true \
...
mltb_q -d --profile="$(pwd)"
mltb_s -f sabnzbd/SABnzbd.ini -s :::8070 -b 0 -d -c -l 0 --console