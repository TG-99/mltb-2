...
@app.route('/')
def homepage():
    return "<h1>This is mirror-leech-telegram-bot modified by <a href='https://github.com/RIR18'>RIR18</a></h1><br><br><h3><a href='/rcl/' target='_blank'>Rclone Index</a><br><a href='/downloads/' target='_blank'>Download Folder</a></h3>"
